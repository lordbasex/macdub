...
| **History › Dubbing** — recorded audio with a live spectrum, the transcript following karaoke-style, playback modes, transcription · audio · total times per sentence, right-click to copy a line ![History with player](images/history.png) | **History › Live translation** — each conversation as a chat, both sides' audio in one take, times per sentence, right-click to copy a line ![History of a live translation conversation](images/history-live.png) |
